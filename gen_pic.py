...
def draw_gp(n=100):
    # Construct L as the standard five-point stencil
...
def main():
    # Parse dimension of (square) image from command line
    # along with verbose and save flags
    parser = argparse.ArgumentParser()
    parser.add_argument("--dim", 
                help="Dimension of square GP image", type=int)
    parser .add_argument("--verbose",
                help="Plot the gp", action="store_true")
    parser.add_argument("--save",
                help="Save gp draw to .png", action="store_true")
